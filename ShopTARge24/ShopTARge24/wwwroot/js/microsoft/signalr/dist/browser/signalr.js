(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (() => {
    ...
    })(LogLevel || (LogLevel = {})); // ./src/Loggers.ts
    ...
    NullLogger.instance = new NullLogger(); // ./src/pkg-version.ts

    const VERSION = "10.0.0"; // ./src/Utils.ts
    ...
    })(MessageType || (MessageType = {})); // ./src/Subject.ts
      ...
      async _reconnect(error) {
        ...
        while (nextRetryDelay !== null) {
          this._logger.log(
            ...
            } will start in ${nextRetryDelay} ms.`
          );
      ...
      _cancelCallbacksWithError(error) {
        ...
        Object.keys(callbacks).forEach((key) => {
          ...
          try {
            ...
            this._logger.log(
              LogLevel.Error,
              `Stream 'error' callback called with '${error}' threw error: ${getErrorString(
                e
              )}`
            );
          }
    ...
    HeaderNames.Cookie = "Cookie"; // ./src/AccessTokenHttpClient.ts
    ...
    })(TransferFormat || (TransferFormat = {})); // ./src/AbortController.ts
        ...
        if (this._buffer.length && typeof this._buffer[0] !== typeof data) {
          throw new Error(
            `Expected data to be of type ${typeof this
              ._buffer} but was of type ${typeof data}`
          );
        }
